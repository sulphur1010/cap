...
namespace :unicorn do
	...
	task :update_unicorn_symlinks, :roles => :app do
		run "cd #{release_path}/tmp/sockets && ln -s #{deploy_to}/shared/sockets/unicorn.sock unicorn.sock"
		run "cd #{release_path}/tmp/pids && ln -s #{deploy_to}/shared/pids/unicorn.pid unicorn.pid"
		run "cd #{release_path}/tmp/pids && ln -s #{deploy_to}/shared/pids/unicorn.pid.oldbin unicorn.pid.oldbin"
	end
